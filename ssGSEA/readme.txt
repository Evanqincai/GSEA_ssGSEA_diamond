...
2)ssgsea module:
    command:
         gseapy ssgsea -d /lustre/rdi/user/licq/research/RNA_seq/ssGSEA/GSEApy/demo_FPKM.del2.txt -g /lustre/rdi/user/licq/research/RNA_seq/ssGSEA/GSEApy/database/c2.cp.kegg.v6.2.symbols.gmt -o test_ssgsea 
    参数说明：
     -d     表达量文件 
            注：1) 基因名不能重复出现;
                2) 表达量值为0时，用"NA"替换;
